...
class SQP : STP
{
    ...
    {
        Console.Write("Координаты первой точки: "); Center.Output();
        Console.Write("Координаты второй точки: "); Anydot.Output();
        Console.Write("Координаты третьей точки: "); third.Output();
        Console.Write("Координаты четвертой точки: ");Fourth.Output();
